...
class info(models.Model):
    ...
    bottom_value = models.CharField(max_length=250,null=True, default='0')
    top_value = models.CharField(max_length=250,null=True,default='0')
    supplyline_high = models.CharField(max_length=250,null=True, default='0')
    supplyline_low = models.CharField(max_length=250,null=True, default='0')
    demandline_high = models.CharField(max_length=250,null=True, default='0')
    demandline_low = models.CharField(max_length=250,null=True, default='0')
